...
<p align="center">
  <img src="https://raw.githubusercontent.com/arjunprabhulal/gemma4-agent/main/assets/gemma-agent-cli.png?v=4" alt="gemma4-agent interactive REPL — startup banner and /help command list" width="900">
</p>
...
| `/voice [seconds] [gemma\|whisper] [mute\|unmute]` | Toggle 2-Way Voice Mode — optional wait window, transcription engine (Whisper default, or Gemma 4's native hearing via the 12B — both ~0.8s/utterance warm); spoken replies are muted by default — `unmute` speaks answers aloud |
